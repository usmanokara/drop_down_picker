...
class _DropdownDatePickerState extends State<DropdownDatePicker> {
  ...
  List<Widget> _buildDropdownButtonsByDateFormat() {
    ...
    switch (widget.dateFormat) {
      case DateFormat.dmy:
        dropdownButtonList..add(_buildDayDropdownButton())..add(
            _buildMonthDropdownButton())..add(_buildYearDropdownButton());
        break;
      case DateFormat.ymd:
        dropdownButtonList..add(_buildYearDropdownButton())..add(
            _buildMonthDropdownButton())..add(_buildDayDropdownButton());
        break;
      case DateFormat.mdy:
        dropdownButtonList..add(_buildMonthDropdownButton())..add(
            _buildDayDropdownButton())..add(_buildYearDropdownButton());
        break;
    }
